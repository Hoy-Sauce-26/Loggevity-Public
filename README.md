...
scores your week against mortality-risk research — so you can see the shape
of your own habits instead of guessing at them.
...
Seven categories, each scored out of ten:

- **Moderate activity** — walking, cycling, anything that gets you moving
- **Vigorous activity** — running, intervals, hard effort
- **Resistance training**
- **Flexibility and balance**
- **Time in nature**
- **Socializing** — logged by hours, or answered as a single yes/no question
  each week
- **Sleep**
...
- **No network permission, at all.** The Android app does not request
  `INTERNET`, so the operating system will not let it open a connection even
  if it tried to.
- **No analytics, no advertising, no tracking of any kind.**
- **Encrypted on-device.** Your database is encrypted with a key that is
  generated on your phone and never leaves it.
...
Loggevity is not a medical device. It does not diagnose, treat, or predict
anything, and it is not a substitute for advice from a doctor.

## Get it

*Play Store link goes here once the listing is live.*
